const toolCardMeta = {
  ...
  media_video_speed_preview: { badge: '视频', iconClass: 'fa fa-play-circle-o', styleClass: 'style2' },
  media_tone_generator: { badge: '频率', iconClass: 'fa fa-signal', styleClass: 'style8' },
  media_white_noise_generator: { badge: '白噪音', iconClass: 'fa fa-volume-off', styleClass: 'style6' },

  image_compress_batch: { badge: '压缩', iconClass: 'fa fa-compress', styleClass: 'style3' },
  image_resize_exact: { badge: '尺寸', iconClass: 'fa fa-arrows-alt', styleClass: 'style6' },
  image_resize_scale: { badge: '缩放', iconClass: 'fa fa-expand', styleClass: 'style11' },
  image_crop_free: { badge: '裁剪', iconClass: 'fa fa-crop', styleClass: 'style8' },
  ...
  image_dark_mode_background: { badge: '白底', iconClass: 'fa fa-adjust', styleClass: 'style4' },
  image_watermark_tile: { badge: '水印', iconClass: 'fa fa-tint', styleClass: 'style10' },
  image_grayscale: { badge: '黑白', iconClass: 'fa fa-adjust', styleClass: 'style2' },
  image_invert: { badge: '反相', iconClass: 'fa fa-exchange', styleClass: 'style1' },
  ...
  image_add_padding: { badge: '留白', iconClass: 'fa fa-square-o', styleClass: 'style5' },
  ...
  image_modify_dpi: { badge: 'DPI', iconClass: 'fa fa-dot-circle-o', styleClass: 'style12' },
  gif_split: { badge: 'GIF', iconClass: 'fa fa-film', styleClass: 'style10' },
  gif_merge: { badge: 'GIF', iconClass: 'fa fa-play-circle-o', styleClass: 'style7' },
  png_alpha_invert: { badge: 'PNG', iconClass: 'fa fa-adjust', styleClass: 'style1' },
  image_round_corner: { badge: '圆角', iconClass: 'fa fa-circle-o', styleClass: 'style15' },
  image_tile_fill: { badge: '平铺', iconClass: 'fa fa-th', styleClass: 'style4' },
  id_photo_resize: { badge: '证件照', iconClass: 'fa fa-id-card-o', styleClass: 'style8' },
  exam_id_photo_process: { badge: '报名照', iconClass: 'fa fa-id-card-o', styleClass: 'style10' },
  ...
  dev_qq_block_check: { badge: 'qq', iconClass: 'fa fa-qq', styleClass: 'style5' },
  dev_wechat_block_check: { badge: '微信', iconClass: 'fa fa-weixin', styleClass: 'style14' },
  dev_cdn_node_ip_check: { badge: 'cdn', iconClass: 'fa fa-cloud-download', styleClass: 'style11' },
  dev_seo_backlink_publish: { badge: 'SEO优化', iconClass: 'fa fa-line-chart', styleClass: 'style6' },
  dev_ip_random_generate: { badge: 'ip', iconClass: 'fa fa-random', styleClass: 'style1' },
  dev_ip_generate: { badge: 'IP生成', iconClass: 'fa fa-random', styleClass: 'style8' },
  dev_ip_range_restore: { badge: 'ip', iconClass: 'fa fa-sitemap', styleClass: 'style5' },
  dev_ip_to_number: { badge: 'IP转数字', iconClass: 'fa fa-calculator', styleClass: 'style12' },
  dev_mac_generate: { badge: 'MAC生成', iconClass: 'fa fa-id-card', styleClass: 'style5' },
  dev_ipv4_to_ipv6: { badge: 'IPv4转IPv6', iconClass: 'fa fa-exchange', styleClass: 'style2' },
  dev_sha1_hash: { badge: 'SHA1加密', iconClass: 'fa fa-lock', styleClass: 'style9' },
  dev_sha224_hash: { badge: 'SHA224', iconClass: 'fa fa-lock', styleClass: 'style4' },
  dev_sha256_hash: { badge: 'SHA256', iconClass: 'fa fa-lock', styleClass: 'style1' },
  dev_sha384_hash: { badge: 'SHA384', iconClass: 'fa fa-lock', styleClass: 'style13' },
  dev_sha512_hash: { badge: 'SHA512', iconClass: 'fa fa-lock', styleClass: 'style8' },
  dev_ascii_batch_encode: { badge: '支付', iconClass: 'fa fa-font', styleClass: 'style11' },
  dev_image_to_base64: { badge: '图片', iconClass: 'fa fa-picture-o', styleClass: 'style9' },
  dev_base64_to_image: { badge: '图片', iconClass: 'fa fa-picture-o', styleClass: 'style9' },
  dev_random_color_generate: { badge: '颜色生成', iconClass: 'fa fa-paint-brush', styleClass: 'style2' },
  dev_rich_text_editor: { badge: '富文本编辑器', iconClass: 'fa fa-pencil-square-o', styleClass: 'style5' },
  dev_ckeditor4: { badge: 'CKEditor4', iconClass: 'fa fa-edit', styleClass: 'style8' },
  dev_ckeditor5: { badge: 'CKEditor5', iconClass: 'fa fa-pencil-square-o', styleClass: 'style13' },
  dev_tinymce: { badge: 'TinyMCE', iconClass: 'fa fa-edit', styleClass: 'style2' },
  dev_win_desktop_client_generator: { badge: 'windows', iconClass: 'fa fa-windows', styleClass: 'style15' },
  dev_bt_firewall_ip_import: { badge: '宝塔', iconClass: 'fa fa-shield', styleClass: 'style10' },
  dev_fontawesome_to_image: { badge: 'FontAwesome', iconClass: 'fa fa-font-awesome', styleClass: 'style6' },
  dev_google_translate_tag_clean: { badge: '谷歌翻译', iconClass: 'fa fa-language', styleClass: 'style1' },
  dev_dlib_face_landmarks: { badge: '人脸识别', iconClass: 'fa fa-user-circle-o', styleClass: 'style1' }
};
